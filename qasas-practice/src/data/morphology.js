...
const PAST_FORMS = [
  {
    key: '3ms',
    suffix: 'َ',
    ar: 'غَائِب مُذَكَّر وَاحِد',
    en: 'third person masculine singular',
    active: 'he {past}',
    passive: 'he was {passive}',
  },
  {
    key: '3md',
    suffix: 'َا',
    ar: 'غَائِب مُذَكَّر تَثْنِيَة',
    en: 'third person masculine dual',
    active: 'they (dual masculine) {past}',
    passive: 'they (dual masculine) were {passive}',
  },
  {
    key: '3mp',
    suffix: 'ُوا',
    ar: 'غَائِب مُذَكَّر جَمْع',
    en: 'third person masculine plural',
    active: 'they (plural masculine) {past}',
    passive: 'they (plural masculine) were {passive}',
  },
  {
    key: '3fs',
    suffix: 'َتْ',
    ar: 'غَائِب مُؤَنَّث وَاحِد',
    en: 'third person feminine singular',
    active: 'she {past}',
    passive: 'she was {passive}',
  },
  {
    key: '3fd',
    suffix: 'َتَا',
    ar: 'غَائِب مُؤَنَّث تَثْنِيَة',
    en: 'third person feminine dual',
    active: 'they (dual feminine) {past}',
    passive: 'they (dual feminine) were {passive}',
  },
  {
    key: '3fp',
    suffix: 'ْنَ',
    ar: 'غَائِب مُؤَنَّث جَمْع',
    en: 'third person feminine plural',
    active: 'they (plural feminine) {past}',
    passive: 'they (plural feminine) were {passive}',
  },
  {
    key: '2ms',
    suffix: 'ْتَ',
    ar: 'حَاضِر مُذَكَّر وَاحِد',
    en: 'second person masculine singular',
    active: 'you (singular masculine) {past}',
    passive: 'you (singular masculine) were {passive}',
  },
  {
    key: '2md',
    suffix: 'ْتُمَا',
    ar: 'حَاضِر مُذَكَّر تَثْنِيَة',
    en: 'second person masculine dual',
    active: 'you (dual masculine) {past}',
    passive: 'you (dual masculine) were {passive}',
  },
  {
    key: '2mp',
    suffix: 'ْتُمْ',
    ar: 'حَاضِر مُذَكَّر جَمْع',
    en: 'second person masculine plural',
    active: 'you (plural masculine) {past}',
    passive: 'you (plural masculine) were {passive}',
  },
  {
    key: '2fs',
    suffix: 'ْتِ',
    ar: 'حَاضِر مُؤَنَّث وَاحِد',
    en: 'second person feminine singular',
    active: 'you (singular feminine) {past}',
    passive: 'you (singular feminine) were {passive}',
  },
  {
    key: '2fd',
    suffix: 'ْتُمَا',
    ar: 'حَاضِر مُؤَنَّث تَثْنِيَة',
    en: 'second person feminine dual',
    active: 'you (dual feminine) {past}',
    passive: 'you (dual feminine) were {passive}',
  },
  {
    key: '2fp',
    suffix: 'ْتُنَّ',
    ar: 'حَاضِر مُؤَنَّث جَمْع',
    en: 'second person feminine plural',
    active: 'you (plural feminine) {past}',
    passive: 'you (plural feminine) were {passive}',
  },
  {
    key: '1s',
    suffix: 'ْتُ',
    ar: 'مُتَكَلِّم وَاحِد',
    en: 'first person singular',
    active: 'I {past}',
    passive: 'I was {passive}',
  },
  {
    key: '1p',
    suffix: 'ْنَا',
...
const MUDARI_FORMS = [
  {
    ...
    ar: 'غَائِب مُذَكَّر وَاحِد',
    en: 'third person masculine singular',
    active: 'he is {present} or will {base}',
    passive: 'he is being {passive} or will be {passive}',
    negative: 'he does not / cannot {base}',
  },
  {
    key: '3md',
    prefix: 'يَ',
    ...
    ar: 'غَائِب مُذَكَّر تَثْنِيَة',
    en: 'third person masculine dual',
    active: 'they (dual masculine) are {present} or will {base}',
    passive: 'they (dual masculine) are being {passive} or will be {passive}',
    negative: 'they (dual masculine) do not / cannot {base}',
  },
  {
    key: '3mp',
    prefix: 'يَ',
    ...
    ar: 'غَائِب مُذَكَّر جَمْع',
    en: 'third person masculine plural',
    active: 'they (plural masculine) are {present} or will {base}',
    passive: 'they (plural masculine) are being {passive} or will be {passive}',
    negative: 'they (plural masculine) do not / cannot {base}',
  },
  {
    key: '3fs',
    prefix: 'تَ',
    ...
    ar: 'غَائِب مُؤَنَّث وَاحِد',
    en: 'third person feminine singular',
    active: 'she is {present} or will {base}',
    passive: 'she is being {passive} or will be {passive}',
    negative: 'she does not / cannot {base}',
  },
  {
    key: '3fd',
    prefix: 'تَ',
    ...
    ar: 'غَائِب مُؤَنَّث تَثْنِيَة',
    en: 'third person feminine dual',
    active: 'they (dual feminine) are {present} or will {base}',
    passive: 'they (dual feminine) are being {passive} or will be {passive}',
    negative: 'they (dual feminine) do not / cannot {base}',
  },
  {
    key: '3fp',
    prefix: 'يَ',
    ...
    ar: 'غَائِب مُؤَنَّث جَمْع',
    en: 'third person feminine plural',
    active: 'they (plural feminine) are {present} or will {base}',
    passive: 'they (plural feminine) are being {passive} or will be {passive}',
    negative: 'they (plural feminine) do not / cannot {base}',
  },
  {
    key: '2ms',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُذَكَّر وَاحِد',
    en: 'second person masculine singular',
    active: 'you (singular masculine) are {present} or will {base}',
    passive: 'you (singular masculine) are being {passive} or will be {passive}',
    negative: 'you (singular masculine) do not / cannot {base}',
  },
  {
    key: '2md',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُذَكَّر تَثْنِيَة',
    en: 'second person masculine dual',
    active: 'you (dual masculine) are {present} or will {base}',
    passive: 'you (dual masculine) are being {passive} or will be {passive}',
    negative: 'you (dual masculine) do not / cannot {base}',
  },
  {
    key: '2mp',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُذَكَّر جَمْع',
    en: 'second person masculine plural',
    active: 'you (plural masculine) are {present} or will {base}',
    passive: 'you (plural masculine) are being {passive} or will be {passive}',
    negative: 'you (plural masculine) do not / cannot {base}',
  },
  {
    key: '2fs',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُؤَنَّث وَاحِد',
    en: 'second person feminine singular',
    active: 'you (singular feminine) are {present} or will {base}',
    passive: 'you (singular feminine) are being {passive} or will be {passive}',
    negative: 'you (singular feminine) do not / cannot {base}',
  },
  {
    key: '2fd',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُؤَنَّث تَثْنِيَة',
    en: 'second person feminine dual',
    active: 'you (dual feminine) are {present} or will {base}',
    passive: 'you (dual feminine) are being {passive} or will be {passive}',
    negative: 'you (dual feminine) do not / cannot {base}',
  },
  {
    key: '2fp',
    prefix: 'تَ',
    ...
    ar: 'حَاضِر مُؤَنَّث جَمْع',
    en: 'second person feminine plural',
    active: 'you (plural feminine) are {present} or will {base}',
    passive: 'you (plural feminine) are being {passive} or will be {passive}',
    negative: 'you (plural feminine) do not / cannot {base}',
  },
  {
    key: '1s',
    prefix: 'أَ',
    ...
    ar: 'مُتَكَلِّم وَاحِد',
    en: 'first person singular',
    active: 'I am {present} or will {base}',
    passive: 'I am being {passive} or will be {passive}',
    negative: 'I do not / cannot {base}',
  },
  {
    key: '1p',
    prefix: 'نَ',
    ...
    ar: 'مُتَكَلِّم جَمْع',
    en: 'first person plural',
    active: 'we are {present} or will {base}',
    passive: 'we are being {passive} or will be {passive}',
    negative: 'we do not / cannot {base}',
  },
];
...
const COMMAND_FORMS = [
  {
    ...
    ar: 'حَاضِر مُذَكَّر وَاحِد',
    en: 'second person masculine singular',
    imperative: '{base} (singular masculine)',
    prohibitive: 'do not {base} (singular masculine)',
  },
  {
    key: '2md',
    suffix: 'َا',
    ar: 'حَاضِر مُذَكَّر تَثْنِيَة',
    en: 'second person masculine dual',
    imperative: '{base} (dual masculine)',
    prohibitive: 'do not {base} (dual masculine)',
  },
  {
    key: '2mp',
    suffix: 'ُوا',
    ar: 'حَاضِر مُذَكَّر جَمْع',
    en: 'second person masculine plural',
    imperative: '{base} (plural masculine)',
    prohibitive: 'do not {base} (plural masculine)',
  },
  {
    key: '2fs',
    suffix: 'ِي',
    ar: 'حَاضِر مُؤَنَّث وَاحِد',
    en: 'second person feminine singular',
    imperative: '{base} (singular feminine)',
    prohibitive: 'do not {base} (singular feminine)',
  },
  {
    key: '2fd',
    suffix: 'َا',
    ar: 'حَاضِر مُؤَنَّث تَثْنِيَة',
    en: 'second person feminine dual',
    imperative: '{base} (dual feminine)',
    prohibitive: 'do not {base} (dual feminine)',
  },
  {
    key: '2fp',
    suffix: 'ْنَ',
    ar: 'حَاضِر مُؤَنَّث جَمْع',
    en: 'second person feminine plural',
    imperative: '{base} (plural feminine)',
    prohibitive: 'do not {base} (plural feminine)',
  },
];
